...
while(j < ColMax+1 && num > 0) #Columns 1147 
  {
    while(i < RowMax) #Rows 289   
      {
      if(i==NoConfirmRow[1] || i==NoConfirmRow[2])
        {num <- 1}
      else
        {num <- confirmed_global[i,j]}
              
      cat("Inside - Row:",i,"Col:",j,",confirmed_global:",num,"\n")
      i <- i + 1   
...
#Row:277, Col: 915 --Pitcairn IslandS
#cat("Province/State: ",confirmed_global[j,1],"Country/Region: ",confirmed_global[j,2],"\n")
#cat("Latitude: ",confirmed_global[j,3]," ,Longitude:",confirmed_global[j,4],"\n")
#cat("Here is the most recent area to have a first confirmed case.", ColName[i] ,"at:",confirmed_global[j,i],"\n")
```
